...
def get_idiom_for_target_multi_improve(tree):
    code_list = []
...
'''
   ...
   #
    # util.save_csv(util.data_root+"idiom_code_dir_star_1000/multi_targets_for_larger_than_2.csv",result_compli_for_else_list,["repo_name","code1","num_vars","file_html","file_path"])
    # util.save_csv(util.data_root+"idiom_code_dir_star_1000/multi_targets_for_sample.csv",result_compli_for_else_list[:382],["repo_name","code1","num_vars","file_html","file_path"])

    # util.save_csv(util.data_root+"idiom_code_dir_star_1000/multi_targets_for.csv",result_compli_for_else_list[:377],["repo_name","code1","num_vars","file_html","file_path"])
    #'''
