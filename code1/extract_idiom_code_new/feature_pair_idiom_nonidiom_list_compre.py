...
def save_to_csv(save_complicated_code_dir_pkl):
    ...
    #     print("each code: ",e)
    util.save_csv(util.data_root + "detection_idiom_code_dir_star_1000_csv/list_comprehension_idiom_code.csv",
                  result_compli_for_else_list,
...
'''
    ...
    # repo_name_list=["powerline"]#["business-rules"]#["satellite"]
