...
import util
import shutil
from wrap_refactoring import refactor_multi_ass
...
for i in range(4262441):
    ...
    new_code_list=refactor_multi_ass.refactor_multi_ass(file_path)
    # if new_code_list:
    ...
    assign_list,body_list=extract_compli_multiple_assign_code_improve_complete_improve.get_multiple_assign(tree)
    # print(">>>ass: ", assign_list)
    for ass_list in assign_list:
        ...
        for ass in ass_list:
            ...
            if ass.lineno not in lineno_list:
                ...
                need_to_check_file_name_excel.append(
                    [file_name, ass.lineno, ass_list[-1].lineno, ast.unparse(parent_node_1),
