...
r
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
        ...
        # util.save
        # evaluation_testing_dir = util.data_root + "5_10_all_test_cases/code_info_3215/dict_compreh/"  # test_case_benchmark_dir_csv/"#
        evaluation_testing_dir = util.data_root + "5_10_all_test_cases/code_info_3215/dict_compreh/" #dict_compreh_own_config # test_case_benchmark_dir_csv/"#
