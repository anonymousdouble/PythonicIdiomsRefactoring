...
if __name__ == '__main__':
    ...
    save_for_else_complicated_code_dir_pkl= util.data_root + "transform_complicate_to_simple_pkl/chain_ass_same_value/"
    ...
    save_for_else_methods_dir = util.data_root + "methods/chain_ass_same_value_complicated/"
