...
if __name__ == '__main__':
    ...
    save_test_file_res_dir_list=["for_compre_list/","for_compre_dict/","for_compre_dict/","for_compre_dict_own_config/","for_compre_set/","for_compre_set_improve/","for_compre_set_all/",
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (arg_list, new_tree) in enumerate(complicate_code[file_html][cl][me]):
                                        ...
                                        for test_html,each_rela_path, tc_cl, tc_me in test_me_inf_list:
                                            ...
                                            dict_test_me_map_api_num[(str(arg_list), new_tree)] = [fully_test_me,count_api]
                                        ...
                                        if str_info in code_info_list:
                                            # code_count+=1
                                            # code_info_cla=code_info.CodeInfo(repo_name,file_html,cl,me,[arg_list, new_tree], test_me_inf_list)
                                            # if i==2 or i==4:
        ...
        util.save_pkl(sum_test_method_count_dir,"call_star",dict_test_me_map_api_num)
