...
if __name__ == '__main__':
    ...
    save_for_else_methods_dir = util.data_root + "idiom_methods/multip_assign_complicated/"
    ...
    repo_list=[]
    for repo in os.listdir(save_for_else_complicated_code_dir_pkl):
        repo_list.append(repo[:-4])
    ...
    #'''
    pool = newPool(nodes=30)
    pool.map(save_me_test_me, list(repo_list))  # [:3]sample_repo_url ,token_num_list[:1]
