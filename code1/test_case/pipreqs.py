...
def get_all_imports(
    ...
    candidates = []
    ignore_errors = False
    ignore_dirs = [".hg", ".svn", ".git", ".tox", "__pycache__", "env", "venv","venv_test_5","venv_test_6","venv_test_7","venv_test_8","venv_test_9",
                   "venv_test_require_7","venv_test_require_6","venv_test_require_8","venv_test_require_9","venv_test_require_new_7","venv_zejun_config7"]
        ...
        for root, dirs, files in os.walk(path):
            for item in files:
                if "top_level" in item:
                    if "venv_test" in item or "venv_zejun" in item:
                        continue
...
def init(input_path,save_path):
    encoding = None
    extra_ignore_dirs = []
    follow_links = not False
    # input_path =
    ...
    path = (save_path if save_path else
...
def main():  # pragma: no cover
    ...
    input_path="./"#"/data1/zhangzejun/mnt/zejun/smp/data/python_star_2000repo/pfrl"#"./"
    save_path="requirements_my_gen.txt"
    try:
        init(input_path,save_path)
...
if __name__ == '__main__':
    ...
    a=get_imports_info(
        ['pytest'], pypi_server="https://pypi.python.org/pypi/", proxy=None)
    print(a)