...
if __name__ == '__main__':
    ...
    save_me_test_me_dir= util.data_root + "idiom_methods_test_method_pair/multip_assign_complicated/"
    ...
    save_test_file_res_dir = util.data_root + "idiom_save_test_file_res_dir/multip_assign_complicated/"
    ...
    for file_name in os.listdir(save_me_test_me_dir):
        ...
        if os.path.exists(save_me_test_me_dir + repo_name + ".pkl") and not os.path.exists(
                save_test_file_res_dir + repo_name + ".pkl"):
            repo_list.append([repo_name, save_me_test_me_dir, save_test_file_res_dir, "venv_test_require_new_",False,pip_install_again])
