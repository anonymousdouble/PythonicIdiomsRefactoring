                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (arg_list, new_tree) in enumerate(complicate_code[file_html][cl][me]):
                                    ...
                                    try:
                                        ...
                                        traceback.print_exc()
                                        print("error file html: ",file_html)
                                    if flag_same:
                                        print("please check because the code1 is not changed: ", file_html)
                                        continue
...
if __name__ == '__main__':
    ...
    complicated_code_dir_pkl= util.data_root + "transform_complicate_to_simple_pkl/var_unpack_call_star_complicated_strict/"
    pro_path = util.data_root + "python_star_2000repo/"
    save_acc_res_csv_dir= util.data_root + "acc_res_compli_test_case/var_unpack_call_star_complicated_strict.csv"
    save_test_acc_dir = util.data_root + "acc_res_compli_test_case/var_unpack_call_star_complicated_acc_dir_strict/"
