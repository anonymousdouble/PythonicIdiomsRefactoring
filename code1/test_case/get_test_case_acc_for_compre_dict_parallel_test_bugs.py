...
def get_each_repo_test_acc(file):
    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            flag_file=0
            if file_html in dict_complica_me_list:
                if file_html != "https://github.com/shuup/shuup/tree/master/shuup/admin/modules/orders/sections.py":#"https://github.com/fastavro/fastavro/tree/master/fastavro/_schema_py.py":  # "https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/shuup/shuup/tree/master/shuup/front/utils/product.py":#"https://github.com/soxoj/maigret/tree/master/maigret/report.py":#"https://github.com/PyTorchLightning/metrics/tree/master/torchmetrics/functional/text/rouge.py":
                    continue
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (for_node, assign_node,remove_ass_flag, new_tree) in enumerate(
                                    ...
                                    # print("come to complicate_code: ", file_html)
                                    print(">>>>>>>>>>>>>>>>>>>>new_tree:\n ", new_tree.lineno, ast.unparse(new_tree))  #
                                    print(">>>>>>>>>>>>>>>>>>>>old_tree:\n ", remove_ass_flag,for_node.lineno,
