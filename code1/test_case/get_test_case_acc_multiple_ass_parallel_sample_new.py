...
def get_each_repo_test_acc(info_list):
    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            if file_html!="https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/schema.py":
                continue
...
if __name__ == '__main__':
    ...
    #     os.makedirs(save_test_acc_dir)
    repo_name_list=['cloud-custodian']#['routersploit','featuretools','moto','django-rest-framework',\'networkx','apprise','mlxtend','pymc']
    for file in os.listdir(save_test_file_res_dir):
