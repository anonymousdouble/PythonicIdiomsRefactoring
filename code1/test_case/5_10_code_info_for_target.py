...
if __name__ == '__main__':
    file_path = util.data_root + "testing/for_target.csv"
    save_me_test_me_dir_list = [
        "var_unpack_for_target_complicated/", "var_unpack_for_target_complicated/"]
    save_test_file_res_dir_list = ["var_unpack_for_target_complicated/", "var_unpack_for_target_complicated_own_config/"
                                   ]
    complicated_code_dir_pkl_list = ["var_unpack_for_target_complicated/", "var_unpack_for_target_complicated/"]
    save_test_acc_dir_list = ["var_unpack_for_target_complicated_dir/", "var_unpack_for_target_complicated_dir/"]
    # '''
    file_name_list=["for_target","for_target_own_config"]
    ...
    for i in range(len(save_test_file_res_dir_list[:])):
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (old_tree, new_tree) in enumerate(
                                        ...
                                        if str_info in code_info_list and str_info not in str_info_list:
                                            str_info_list.append(str_info)
                                            code_count += 1

                                            if str_info not in list_code_info_list:
        ...
        # evaluation_testing_dir = util.data_root + "5_10_all_test_cases/code_info_3215/for_target/"  # test_case_benchmark_dir_csv/"#
        evaluation_testing_dir = util.data_root + "5_10_all_test_cases/code_info_3215/"+file_name_list[i]+"/"  # test_case_benchmark_dir_csv/"#
