...
if __name__ == '__main__':
    ...
    for i in range(len(file_path_list)):
        if i!=0:# set_comprehension
            continue
        # if i!=4 and i!=5:# call star
        #     continue
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (for_node, assign_node, remove_ass_flag, new_tree) in enumerate(
                                        ...
                                        for test_html,each_rela_path, tc_cl, tc_me in test_me_inf_list:
                                            ...
                                            dict_test_me_map_api_num[(for_node, assign_node, remove_ass_flag, new_tree)] = [fully_test_me,count_api]
        ...
        # print("dict_test_me_map_api_num: ",dict_test_me_map_api_num)
        sum_cout=0
        ...
        # util.save_pkl(sum_test_method_count_dir,"list_compreh",dict_test_me_map_api_num)

        # util.save_pkl(sum_test_method_count_dir,"list_compreh",dict_test_me_map_api_num)
        # util.save_pkl(sum_test_method_count_dir,"set_compreh",dict_test_me_map_api_num)
        # util.save_pkl(sum_test_method_count_dir,"dict_compreh",dict_test_me_map_api_num)
