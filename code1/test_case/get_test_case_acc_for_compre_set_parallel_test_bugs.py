    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                ...
                # if file_html!="https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#":#"https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                #     continue
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (for_node, assign_node,remove_ass_flag, new_tree) in enumerate(
                                    ...
                                    print(">>>>>>>>>>>>>>>>>>>>old_tree:\n ", for_node.lineno, ast.unparse(assign_node),
                                          ast.unparse(for_node))  # old_tree.lineno,
                                    ...
                                    for test_html,each_rela_path, cl, me in test_me_inf_list:
                                        ...
                                        if not flag_pass:
                                            util.save_file_path(old_path, old_content)
                                            res.append(
                                                [repo_name, file_html, test_info, str(flag_pass), ast.unparse(for_node),
                                                 ast.unparse(new_tree)])
                                            # print(">>>>>>>>>>old_content: ", old_content)
...
if __name__ == '__main__':
    ...
    # save_test_acc_dir = util.data_root + "acc_res_compli_test_case/for_compre_set_acc_dir/"
    ...
    repo_list = []
    for file in os.listdir(save_test_file_res_dir):
        if file!="sympy.pkl":#"policy_sentry.pkl":
            continue
        repo_list.append(file)
        get_each_repo_test_acc(file)
