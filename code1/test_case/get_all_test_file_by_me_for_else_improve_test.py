...
if __name__ == '__main__':
    ...
    save_complicated_code_dir_pkl = util.data_root + "transform_complicate_to_simple_pkl_improve_new_modify_remove_flag/for_else_improve_new_modify_bugs_final/"
    save_complicated_code_dir_pkl = util.data_root + "transform_complicate_to_simple_pkl_improve_new_modify_bugs_final/for_else/"
    save_for_else_complicated_code_dir_pkl = util.data_root + "transform_complicate_to_simple_pkl_improve_new_modify_bugs_final/for_else/"
    ...
    save_for_else_methods_dir = util.data_root + "methods/for_else_improve/"
    save_for_else_methods_dir = util.data_root + "methods/for_else_improve_new_modify_remove_flag/"
    save_for_else_methods_dir = util.data_root + "methods/for_else_improve_new_modify_bugs_final_test/"
    ...
    save_me_test_me_dir= util.data_root + "methods_test_method_pair/for_else_improve_new_modify_remove_flag/"
    save_me_test_me_dir = util.data_root + "methods_test_method_pair/for_else_improve_new_modify_bugs_final_test/"
    ...
    # 存储每个项目的每个文件下的每个方法下对应的complicate code1 的数目
    transform_me_full_name(save_for_else_complicated_code_dir_pkl, save_for_else_methods_dir)
    '''


    # 存储含有complicate code的项目的每个文件下的每个方法下对应的测试文件的测试方法集
    ...
    for repo_name in dict_intersect_test_methods:
        ...
        #     continue
        # break
    # 在complicated code对应的项目,文件，方法中有多少是存在测试用例的
    end_time = time.time()
