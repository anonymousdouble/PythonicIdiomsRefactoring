...
#/mnt/zejun/smp/data/python_star_2000repo/nni/nni/algorithms/hpo/curvefitting_assessor/model_factory_copy_zejun.py
    for repo_name in dict_repo_file_python:
        if repo_name !="shuup":#"pipreqs":#"shuup":#"maigret":#"metrics":#"policy_sentry":#"nibabel":#"mlens":#"pingouin":#"thunder":#"pingouin":#"mlens":#"patroni":#"cloud-custodian":# "sacred":#"docker-py":#"mitmproxy":#
            continue
...
#https://github.com/kivy/python-for-android/tree/master/pythonforandroid/pythonpackage.py
            ...
            #     continue
            if file_html != "https://github.com/shuup/shuup/tree/master/shuup/front/utils/product.py":  # "https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"#"https://github.com/soxoj/maigret/tree/master/maigret/report.py":##"https://github.com/PyTorchLightning/metrics/tree/master/torchmetrics/functional/text/rouge.py":
                continue
            # if file_html != "https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/shuup/shuup/tree/master/shuup/front/utils/product.py":#"https://github.com/soxoj/maigret/tree/master/maigret/report.py":#"https://github.com/PyTorchLightning/metrics/tree/master/torchmetrics/functional/text/rouge.py":
            #     continue
            real_file_html = file_html.replace("//", "/")
            #
