                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (old_tree, new_tree) in enumerate(
                                    ...
                                    old_content, new_content,flag_same = replace_content_by_ast.replace_content_var_unpack_for_target(repo_name, file_html, old_tree,new_tree)
                                    if flag_same:
...
def get_each_repo_test_acc(file):
    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            if file_html != "https://github.com/novoid/Memacs/tree/master/memacs/lib/mailparser.py":  #"https://github.com/pyGrowler/Growler/tree/master/growler/http/response.py":#"https://github.com/tarpas/pytest-testmon/tree/master/testmon/testmon_core.py":#"https://github.com/coursera-dl/coursera-dl/tree/master/coursera/filtering.py":#"https://github.com/flennerhag/mlens/tree/master/mlens/config.py":#"https://github.com/novoid/Memacs/tree/master/memacs/lib/mailparser.py":  # "https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                continue
            ...
            #     continue
            # if file_html != "https://github.com/thunder-project/thunder/tree/master/thunder/series/readers.py":  # "https://github.com/raphaelvallat/pingouin/tree/master/pingouin/regression.py":#"https://github.com/flennerhag/mlens/tree/master/mlens/config.py":#"https://github.com/zalando/patroni/tree/master/patroni/log.py":#"https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/schema.py":#"https://github.com/IDSIA/sacred/tree/master/sacred/observers/tinydb_hashfs/tinydb_hashfs.py":#"https://github.com/docker/docker-py/tree/master/docker/models/services.py":#"https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/schema.py":#"https://github.com/mitmproxy/mitmproxy/tree/master/mitmproxy/net/http/url.py":#"https://github.com/nccgroup/ScoutSuite/tree/master/ScoutSuite/core/console.py":#"https://github.com/facebookresearch/hydra/tree/master/hydra/_internal/utils.py":#"https://github.com/threat9/routersploit/tree/master/routersploit/modules/exploits/routers/bhu/bhu_urouter_rce.py":#"https://github.com/falconry/falcon/tree/master/falcon/util/sync.py":#"https://github.com/pytoolz/toolz/tree/master/toolz/functoolz.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#"https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/provider.py":#"https://github.com/huggingface/transformers/tree/master/src/transformers/image_utils.py":#"https://github.com/huggingface/transformers/tree/master/src/transformers/trainer_pt_utils.py":#"https://github.com/yt-dlp/yt-dlp/tree/master/yt_dlp/utils.py":#"https://github.com/bottlepy/bottle/tree/master//bottle.py":#"https://github.com/psf/requests/tree/master/requests/cookies.py":#"https://github.com/pytransitions/transitions/tree/master/transitions/core.py":#"https://github.com/zalando/patroni/tree/master/patroni/ctl.py":#"https://github.com/google/yapf/tree/master/yapf/yapflib/file_resources.py":#
            #     continue
...
if __name__ == '__main__':
    ...
    # save_acc_res_csv_dir= util.data_root + "acc_res_compli_test_case/var_unpack_for_target_complicated.csv"
    # save_test_acc_dir = util.data_root + "acc_res_compli_test_case/var_unpack_for_target_complicated_acc_dir/"
    ...
    # pool.join()
    # get_test_acc()
# Error ["https://github.com/flennerhag/mlens/tree/master/mlens/config.py"]
    # Growler.pkl cannot open ./venv_test_require_7/bin/activate
    # pytest-testmon.pkl cannot open ./venv_test_require_7/bin/activate
    # coursera-dl.pkl cannot open ./venv_test_require_7/bin/activate
    time_start = time.time()
    pro_path = util.data_root + "python_star_2000repo/"
    repo_list = []
    for file in os.listdir(save_test_file_res_dir):
        if file !="Memacs.pkl":#"Growler.pkl":#"pytest-testmon.pkl":#"coursera-dl.pkl":#"mlens.pkl":#"pingouin.pkl":#"patroni.pkl":#"thunder.pkl":#"mlens.pkl":#"patroni":#"cloud-custodian":# "sacred":#"docker-py":#"mitmproxy":#
            continue
        get_each_repo_test_acc(file)
        repo_list.append(file)
    # repo_list=["coursera-dl.pkl","pytest-testmon.pkl","Growler.pkl","Memacs.pkl"]
    print("len of repo list: ",len(repo_list))
    # pool = newPool(nodes=30)
    # pool.map(get_each_repo_test_acc, repo_list)  # [:3]sample_repo_url ,token_num_list[:1]
    # pool.close()
    # pool.join()
