    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                ...
                if file_html!="https://github.com/flennerhag/mlens/tree/master/mlens/utils/id_train.py":#"https://github.com/networkx/networkx/tree/master/networkx/generators/classic.py":#"https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                    continue
                                    ...
                                    try:
                                        for test_html,each_rela_path, cl, me in test_me_inf_list:
                                            ...
                                            if not flag_pass:
                                                ...
                                                print(">>>>>>>>>>old_content: ", arg_str_list, ast.unparse(new_tree))
...
if __name__ == '__main__':
    ...
    repo_list = []
    for file in os.listdir(save_test_file_res_dir):
        if file!="mlens.pkl":#"networkx.pkl":
            continue
        repo_list.append(file)
