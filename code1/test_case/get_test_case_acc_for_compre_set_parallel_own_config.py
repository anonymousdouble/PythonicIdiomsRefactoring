    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                ...
                if file_html!="https://github.com/sympy/sympy/tree/master/sympy/polys/distributedmodules.py":#"https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/bndr/pipreqs/tree/master/pipreqs/pipreqs.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#":#"https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                    continue
                ...
                for cl in complicate_code[file_html]:
                    ...
                    for me in complicate_code[file_html][cl]:
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            test_me_inf_list=dict_complica_me_list[file_html][total_name]
                            # print("test_me_inf_list: ",len(test_me_inf_list))
                                ...
                                for ind, (for_node, assign_node,remove_ass_flag, new_tree) in enumerate(
                                    ...
                                    try:
                                        for test_html,each_rela_path, cl, me in test_me_inf_list:
                                            ...
                                            # test_content=util.load_file_path(old_path)
                                            # print(">>>>>>>>>>test_content: ",test_content)
                                            run_test_result = configure_pro_envir_util.run_test_file(test_html, repo_path,ven_name="venv_zejun_config",fun_list=fun_list)
...
if __name__ == '__main__':
    ...
    # repo_list = []
    # for file in os.listdir(save_test_file_res_dir):
    #     # if file!="pipreqs.pkl":#"spiderfoot.pkl":
    #     #     continue
    ...
    # #     repo_list.append(file)
    # repo_list = [
    #     'sympy','arcade','fonttools','RedditDownloader','pdfplumber','pyannotate','truffleHog','pampy']#'salt',
    # # for file in os.listdir(save_test_file_res_dir):
    # #     repo_list.append(file)
    again_repo_list = count_test_case_each_pro.get_fail_projects(save_me_test_me_dir, util.data_root + "get_test_case_acc_for_compre_set_parallel.py/")
