    ...
    for file in os.listdir(save_test_file_res_dir):
        ...
        for test_html in dict_test_html_each_me_res:
            if dict_test_html_each_me_res[test_html]:
                ...
                full_test_me_list.extend(list(dict_test_html_each_me_res[test_html]['test_methods'].keys()))
...
if __name__ == '__main__':
    ...
    save_test_html_me_dir=util.data_root + "test_html/for_else/"
    ...
    # pool.map(save_repo_test_result, list(dict_repo_file_python.keys()))  # [:3]sample_repo_url ,token_num_list[:1]
    # pool.close()
    # pool.join()
