    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                if file_html != "https://github.com/PyCQA/pydocstyle/tree/master/src/pydocstyle/checker.py":#"https://github.com/Diaoul/subliminal/tree/master/subliminal/refiners/tvdb.py":#"https://github.com/PyCQA/pydocstyle/tree/master/src/pydocstyle/checker.py":#"https://github.com/Diaoul/subliminal/tree/master/subliminal/refiners/tvdb.py":  # "https://github.com/indigo-dc/udocker/tree/master/udocker/engine/runc.py":
                    continue
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (old_tree, new_tree) in enumerate(
                                    ...
                                    #     "raise IllegalConfiguration('Cannot pass both select and ignore. They are mutually exclusive.')",
...
if __name__ == '__main__':
    ...
    #     os.makedirs(save_test_acc_dir)
    for file in os.listdir(save_test_file_res_dir):
        if file!="pydocstyle.pkl":#"subliminal.pkl":#"pydocstyle.pkl":#"subliminal.pkl":#"udocker.pkl":
            continue
