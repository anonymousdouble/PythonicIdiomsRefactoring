    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                ...
                if file_html!="https://github.com/NaturalHistoryMuseum/pyzbar/tree/master/pyzbar/locations.py":#"https://github.com/sympy/sympy/tree/master/sympy/polys/ring_series.py":#"https://github.com/google/TensorNetwork/tree/master/tensornetwork/block_sparse/blocksparsetensor.py":#"https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                    continue
                                    ...
                                    try:
                                        for test_html,each_rela_path, cl, me in test_me_inf_list:
                                            ...
                                            if not flag_pass:
                                                ...
                                                # print(">>>>>>>>>>old_content: ", old_content)
                                                print("tree: ", arg_str_list, ast.unparse(new_tree))
...
if __name__ == '__main__':
    ...
    for file_name in os.listdir(save_me_test_me_dir):
        ...
        #     continue
        if repo_name!="pyzbar":#"sympy":#"TensorNetwork":
            continue
