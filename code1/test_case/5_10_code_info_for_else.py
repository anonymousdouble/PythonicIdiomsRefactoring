...
if __name__ == '__main__':
    file_path = util.data_root + "testing/for_else.csv"
    save_me_test_me_dir_list = ["for_else_improve_new_modify_bugs_final/", ]
    save_test_file_res_dir_list = ["for_else_improve_new_modify_bugs_final/"]
    complicated_code_dir_pkl_list = ["transform_complicate_to_simple_pkl_improve_new_modify_bugs_final/for_else/"
                                     ]
    save_test_acc_dir_list = ["for_else_acc_dir/"]
    list_code_info_list = []
    code_count = 0
    csvFile = open(file_path, "r", errors='ignore')
    reader = csv.reader(csvFile)
    ...
    for i in range(len(save_test_file_res_dir_list)):
        ...
        complicated_code_dir_pkl = util.data_root + complicated_code_dir_pkl_list[i]
                            ...
                            if total_name in dict_complica_me_list[file_html]:
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (old_tree, new_tree, break_list_in_for, child, child_copy,
                                        ...
                                        str_info = "".join([file_html, str(child.lineno)])
        ...
        # util.save
        evaluation_testing_dir = util.data_root + "5_10_all_test_cases/code_info_3215/for_else/"  # test_case_benchmark_dir_csv/"#
