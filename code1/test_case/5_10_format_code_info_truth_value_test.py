...
if __name__ == '__main__':
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
                ...
                if file_html in dict_complica_me_list:
                    ...
                    for cl in complicate_code[file_html]:
                        ...
                        for me in complicate_code[file_html][cl]:
                            ...
                            # if file_html!="https://github.com/nipy/nibabel/tree/master/nibabel/volumeutils.py":
                            #     continue
                            if total_name in dict_complica_me_list[file_html]:
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (old_tree, new_tree) in enumerate(
                                        ...
                                        #(<ast.Compare object at 0x7f2749fcc3d0>, <ast.UnaryOp object at 0x7f2749fcc520>)
                                        # if print((old_tree, new_tree))!="(<ast.Compare object at 0x7f2749fcc3d0>, <ast.UnaryOp object at 0x7f2749fcc520>)":
                                        #     continue
        ...
        # util.save_pkl(sum_test_method_count_dir,"truth_value_test",dict_test_me_map_api_num)
