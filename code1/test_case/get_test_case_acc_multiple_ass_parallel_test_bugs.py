...
import time
import util, github_util,configure_pro_envir_util
                    ...
                    for me in complicate_code[file_html][cl]:
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                repo_fla=1
                                me_count+=1
                                for ind, (ass_list, new_tree) in enumerate(
                                    ...
                                    old_content, new_content,flag_same = replace_content_by_ast.replace_content_multi_ass(repo_name, file_html, ass_list,new_tree)
                                    if flag_same:
...
def get_each_repo_test_acc(file):
    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            flag_file=0
            if file_html in dict_complica_me_list:
                if "schema.py" not in file_html:#"tvdb.py""plot_boston_housing_regression_with_model_stacking.py" not in file_html:
                # if file_html!="https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/schema.py":#"https://github.com/mitmproxy/mitmproxy/tree/master/mitmproxy/net/http/url.py":#"https://github.com/docker/docker-py/tree/master/docker/models/services.py":#"https://github.com/pymc-devs/pymc/tree/master/pymc/sampling.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                # if file_html != "https://github.com/kellyjonbrazil/jc/tree/master/jc/parsers/dig.py":#"https://github.com/Erotemic/ubelt/tree/master/ubelt/util_hash.py":#"https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/schema.py":#"https://github.com/Qiskit/qiskit-terra/tree/master/qiskit/circuit/random/utils.py":#"https://github.com/cloud-custodian/cloud-custodian/tree/master/c7n/credentials.py":#"https://github.com/EducationalTestingService/skll/tree/master/tests/utils.py":#"https://github.com/cleanlab/cleanlab/tree/master/cleanlab/classification.py":#"https://github.com/Diaoul/subliminal/tree/master/subliminal/refiners/tvdb.py":#"https://github.com/Neuraxio/Neuraxle/tree/master/examples/sklearn/plot_boston_housing_regression_with_model_stacking.py":#"https://github.com/devbisme/skidl/tree/master/skidl/netlist_to_skidl.py":#"https://github.com/Erotemic/ubelt/tree/master/ubelt/util_hash.py":#"https://github.com/JinnLynn/genpac/tree/master/tests/util.py":  # "https://github.com/akfamily/akshare/tree/master/akshare/cost/cost_living.py":#"https://github.com/encode/django-rest-framework/tree/master/rest_framework/utils/urls.py":  # "https://github.com/spulec/moto/tree/master/moto/utilities/docker_utilities.py":#"https://github.com/mitmproxy/mitmproxy/tree/master/mitmproxy/net/http/url.py":#"https://github.com/docker/docker-py/tree/master/docker/models/services.py":#"https://github.com/mitmproxy/mitmproxy/tree/master/mitmproxy/net/http/url.py":#"https://github.com/facebookresearch/Detectron/tree/master/detectron/modeling/detector.py":#"https://github.com/chainer/chainer/tree/master/chainer/functions/normalization/group_normalization.py":
                # if file_html!="https://github.com/EducationalTestingService/skll/tree/master/tests/utils.py":
                    continue
                    ...
                    for me in complicate_code[file_html][cl]:
                        ...
                        if total_name in dict_complica_me_list[file_html]:
                            ...
                            if complicate_code[file_html][cl][me] and test_me_inf_list:
                                ...
                                for ind, (ass_list, new_tree_content) in enumerate(
                                    complicate_code[file_html][cl][me]):
                                    complic_code_count += 1
                                    ...
                                    for child in ast.walk(ast.parse(new_tree_content)):
                                        if isinstance(child, ast.Assign):
                                            new_tree = child
                                            break
                                    for each_ass in ass_list:
                                        print(">>>>>>>>>>>>>>>>>>>>old_tree:\n ", ast.unparse(each_ass),
                                              each_ass.lineno)  # old_tree.lineno,
                                    ...
                                    for test_html,each_rela_path, cl, me in test_me_inf_list:
                                        ...
                                        if not flag_pass:
                                            util.save_file_path(old_path, old_content)
                                            ass_str=[ast.unparse(e) for e in ass_list]
                                            res.append(
                                                [repo_name, file_html,test_info,str(flag_pass),ass_str, ast.unparse(new_tree)])
                                            # print(">>>>>>>>>>old_content: ", old_content)
                                        ...
                                        util.save_file_path(old_path, old_content)
                                        ass_str = [ast.unparse(e) for e in ass_list]
                                        res.append([repo_name, file_html, test_info,str(1),ass_str, ast.unparse(new_tree)])
                                        # print(repo_path + rela_path)
                                        # break
        #                             # util.save_file_path(old_path, old_content)
        #                             break
...
if __name__ == '__main__':
    ...
    save_acc_res_csv_dir = util.data_root + "acc_res_compli_test_case/multip_assign_complicated.csv"

    save_test_acc_dir = util.data_root + "acc_res_compli_test_case/multip_assign_complicated_acc_dir/"

    pro_path = util.data_root + "python_star_2000repo/"
    repo_list = []#https://github.com/cleanlab/cleanlab/tree/master/cleanlab/classification.py
    for file in os.listdir(save_test_file_res_dir):
        if file!="cloud-custodian.pkl":#"skll.pkl":#"subliminal.pkl":#"Neuraxle.pkl":#"jc.pkl":#"ubelt.pkl":#"cloud-custodian.pkl":#"qiskit-terra.pkl":#"cloud-custodian.pkl":#"skll.pkl":#"cleanlab.pkl":#"subliminal.pkl":#"Neuraxle.pkl":#"skidl.pkl":#"ubelt.pkl":#"genpac.pkl":#"cloud-custodian.pkl":#"mitmproxy.pkl":#"docker-py.pkl":
            continue
