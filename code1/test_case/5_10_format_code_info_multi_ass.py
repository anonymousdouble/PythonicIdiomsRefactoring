...
if __name__ == '__main__':
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
                            ...
                            if total_name in dict_complica_me_list[file_html]:
                                ...
                                if complicate_code[file_html][cl][me] and test_me_inf_list:
                                    ...
                                    for ind, (ass_list, new_tree_content) in enumerate(complicate_code[file_html][cl][me]):
                                        ...
                                        if str((str(ass_list), new_tree_content))!="('[<ast.Assign object at 0x7f6d46117a00>, <ast.Assign object at 0x7f6d46117bb0>]', "bottom_limit_port , upper_limit_port  = int(port_range.split('-')[0]), int(port_range.split('-')[1])")'
                                            continue
                                        for test_html, each_rela_path, tc_cl, tc_me in test_me_inf_list:
                                            ...
                                            dict_test_me_map_api_num[(str(ass_list), new_tree_content)] = [fully_test_me, count_api]
        ...
        # util.save_pkl(sum_test_method_count_dir, "multi_ass", dict_test_me_map_api_num)
