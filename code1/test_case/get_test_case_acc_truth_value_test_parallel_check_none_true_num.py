...
def get_test_acc():
    ...
    total_count = 0
    total_acc_count = 0
    dict_compl_count={"None":0,"True":0,"==":0,"other": []}
    for file in os.listdir(save_test_acc_dir):
        ...
        for comp in res:
            old_compli=comp[-2]
            if "None" in old_compli:
                dict_compl_count["None"]+=1
            elif "True" in old_compli:
                dict_compl_count["True"] += 1
            elif "==" in old_compli:
                dict_compl_count["True"] += 1
            else:
                dict_compl_count["other"] .append(old_compli)
    ...
    print("dict_compl_count: ",dict_compl_count)
...
if __name__ == '__main__':
    ...
    save_test_acc_dir = util.data_root + "acc_res_compli_test_case/truth_value_test_complicated_acc_dir_copy/"
