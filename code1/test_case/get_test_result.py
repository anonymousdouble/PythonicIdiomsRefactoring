...
def pip_install(pro_path,v="9"):
    ...
    cmd_pip_pack = ["echo '", split_install, "' ;","pip3 install pytest pytest-mock requests yarg pytest-cov; pip3 install .; python3 /mnt/zejun/smp/code1/test_case/pipreqs.py; "]
