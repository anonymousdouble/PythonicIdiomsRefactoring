...
def save_code_map_test_cases(repo_name):
    ...
    for file_html,code_cl,code_me, (old_tree, new_tree) in dict_test_case_inf_selct[repo_name]:
        old_content, new_content, flag_same = c_replace_content_by_ast_5_10.replace_content_var_unpack_for_target_insert_comehere(repo_name, file_html, old_tree,new_tree)
...
if __name__ == '__main__':
    ...
    dict_code_map_pass_test_case_code_dir = util.data_root + "5_10_all_test_cases/map_code_info_test_case/for_target/"
    ...
    remain_list=[e for e in selct_repo_list if e in repo_exist_test_case and e+".pkl" in os.listdir(dict_code_map_pass_test_case_code_dir)]
    '''
    ...
    '''
    #'''
    print("len: ",len(remain_list),list(set(remain_list)))
    count_test_case=0
    old_test_case=0
    count_code=0
