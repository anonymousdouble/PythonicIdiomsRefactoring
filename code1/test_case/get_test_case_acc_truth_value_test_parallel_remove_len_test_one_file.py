    ...
    # for file in os.listdir(save_test_file_res_dir):
        ...
        for file_html in complicate_code:
            ...
            if file_html in dict_complica_me_list:
                ...
                if file_html!="https://github.com/jupyterhub/the-littlest-jupyterhub/tree/master/tljh/conda.py":#"https://github.com/smicallef/spiderfoot/tree/master//sflib.py":#"https://github.com/smicallef/spiderfoot/tree/master//sfwebui.py":#
                    continue
...
if __name__ == '__main__':
    ...
    #truth_value_test_complicated_remove_is_is_not_no_len
    ...
    #     os.makedirs(save_test_acc_dir)
    #https://github.com/jupyterhub/the-littlest-jupyterhub/tree/master/tljh/conda.py
    for file in os.listdir(save_test_file_res_dir):
        if file!="the-littlest-jupyterhub.pkl":
            continue
        get_each_repo_test_acc([file, save_test_file_res_dir, save_me_test_me_dir, complicated_code_dir_pkl])
