                                    ...
                                    try:
                                        for test_html,each_rela_path, cl, me in test_me_inf_list:
                                            ...
                                            if not flag_pass:
                                                util.save_file_path(old_path, old_content)
                                                res.append(
                                                    [repo_name, file_html, test_info, str(flag_pass),
                                                     ast.unparse(call_node), ast.unparse(new_tree)])
                                                # print(">>>>>>>>>>old_content: ", old_content)
                                            ...
                                            util.save_file_path(old_path, old_content)
                                            res.append([repo_name, file_html, test_info, str(1), ast.unparse(call_node),
                                                        ast.unparse(new_tree)])
                                    except:
                                        print(
...
if __name__ == '__main__':
    ...
    repo_list = []
    for file in os.listdir(save_test_file_res_dir):
        if file!="mlens.pkl":#"budoux.pkl":#"OpenFermion.pkl":#"mlens.pkl":
            continue
