...
if __name__ == '__main__':
    ...
    # file_path = util.data_root + "testing/for_compre_list.csv"
                                    ...
                                    for ind, (old_tree, new_tree, break_list_in_for, child, child_copy,
                                     ass_init, if_varnode, init_ass_remove_flag) in enumerate(
                                        ...
                                        if str_info in code_info_list and str_info not in str_info_list:
                                            ...
                                            code_count+=1
                                     #        code_info_cla=code_info.CodeInfo(repo_name,file_html,cl,me,[old_tree, new_tree, break_list_in_for, child, child_copy,
                                     # ass_init, if_varnode, init_ass_remove_flag], test_me_inf_list)
                                     #        if i==0:
        ...
        util.save_pkl(sum_test_method_count_dir, "for_else", dict_test_me_map_api_num)
