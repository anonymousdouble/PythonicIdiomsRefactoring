        ...
        for ind,child in enumerate(tree.body):
            ...
            if isinstance(child, (ast.For, ast.While)):
                ...
                if break_flag:
                    ...
                    if flag_simplify:
                        # print(">>>>>>>>>>>>>old tree:\n",ast.unparse(child_copy),child_copy.lineno)
...
'''
    ...
    for ind, repo_name in enumerate(dict_repo_file_python):
        if repo_name!="hachoir":#"python-samples":#"sympy":
            continue
    ...
    # util.save_csv(util.data_root + "result_csv/for_else_improve_modify_remove_flag.csv",
