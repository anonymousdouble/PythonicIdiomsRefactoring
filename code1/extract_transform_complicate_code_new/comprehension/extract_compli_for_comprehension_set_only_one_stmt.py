    ...
    for file_info in dict_repo_file_python[repo_name]:
        ...
        try:
            ...
            for tree, class_name in ana_py.func_def_list:
                ...
                new_code_list = extract_compli_for_comprehension_logic.get_complicated_for_comprehen_code_list(
                    tree, content,
                    ["set()"], "add")

                # new_code_list = extract_compli_for_comprehension_logic.get_complicated_for_comprehen_code_list(tree, content)
                for ind, (for_node, assign_node, remove_ass_flag, extend_flag) in enumerate(
                        new_code_list):
                ...
                # for ind, (for_node, assign_node,remove_ass_flag) in enumerate(new_code_list):
                    new_code_list[ind].append(
                        transform_comprehension_set_compli_to_simple.transform(for_node, assign_node,extend_flag))
