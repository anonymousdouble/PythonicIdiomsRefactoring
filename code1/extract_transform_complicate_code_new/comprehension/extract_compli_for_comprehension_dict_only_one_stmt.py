            ...
            for child in node.body:
                if isinstance(child, ast.Assign):
                    ...
                    if isinstance(child,ast.For) and child.lineno==for_node.lineno:
                        # print("come here it does not need to remove the ass: \n",ast.unparse(tree))
                        flag=2
                        break
...
def save_one_repo(repo_name):
    ...
    for file_info in dict_repo_file_python[repo_name]:
        ...
        #     continue
        # if file_html!="https://github.com/python-poetry/poetry/tree/master/poetry/puzzle/solver.py":#"https://github.com/Rockyzsu/stock/tree/master//fupan.py":#"https://github.com/OctoPrint/OctoPrint/tree/master/src/octoprint/server/views.py":
        #     continue
...
'''
    ...
    for ind, repo_name in enumerate(dict_repo_file_python):
        # if repo_name!="networkx":#"sacred":#"networkx":#"cloud-custodian":#"poetry":#"OctoPrint":#"keras-bert":#"Legofy":
        #     continue
