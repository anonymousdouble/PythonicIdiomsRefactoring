...
from extract_transform_complicate_code_new.transform_for_else_compli_to_simple_improve_copy_result_csv_new import traverse_cur_layer
...
def refactor_for_else_by_method(tree):
...
if flag==True:
    ...
    '''
    tree=ast.parse(code)
    info_list=refactor_for_else_by_method(tree)
