...
class RewriteName(ast.NodeTransformer):
        ...
        def generic_visit(self, node):
            node_str=ast.unparse(node)
            if node_str in self.Map_var:
                # print("yes it need to replce:",self.Map_var,node,self.Map_var[node_str],ast.unparse(self.Map_var[node_str]))
                if node_str.startswith("*"):
                    return self.Map_var[node_str]
                else:
                    return self.Map_var[node_str]

                # return ast.Expr(self.Map_var[node_str])
            #
...
def transform_for_node_var_unpack(for_node,node_list,Map_var):
    try:
        ...
        #         print("yes: ", a)
        # print("transform_for_node_var_unpack_for_node:",ast.unparse(for_node))
        for_node.target = tuple
        # print("transform_for_node_var_unpack_for_node_target:",ast.unparse(for_node))
